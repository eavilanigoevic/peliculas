        ...
        <div className="col-md-9 col-sm-12 col-xs-12">
          <div className="blog-detail-ct">
            ...
            <p>
              ...
              DC Extended Universe and Warner Bros., closing in on a deal to
              write direct and produce a Batgirl movie.
            </p>
            ...
            <p>
              ...
              appearing in 1967 in Gardner Fox and Carmine Infantino's story run
              The Million Dollar Debut Of Batgirl, she's the superhero alias of
              Barbara Gordon, daughter of Gotham City Police Commissioner James
              Gordon. So we can likely expect J.K. Simmons' take on Gordon to
              appear along with other Bat-related characters.
            </p>
            ...
            <p>
              ...
              one expected only one ticket sale. As of Tuesday, the Reel Cinema
              in Burnley was still carrying Man Down, which also stars Gary
              Oldman, Jai Courtney and Kate Mara.
            </p>
            <p>
              ...
              <div className="cmt-item flex-it">
                ...
                <div className="author-infor">
                  ...
                  <p>
                    ...
                    singing about deportees and talking social activism as well
                    as joking about her age and the likelihood that a good
                    portion of the Barclays.{" "}
                  </p>
                  <p>
                    <a className="rep-btn" href="#">
                      + Reply
